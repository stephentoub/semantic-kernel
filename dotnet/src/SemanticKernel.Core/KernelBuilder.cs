...
/// <summary>Provides a builder for constructing <see cref="Kernel"/> instances using a fluent builder pattern.</summary>
public sealed class KernelBuilder
{
    ...
    public static Kernel Create() =>
        new(null, new AIServiceCollection().Build(), null, NullHttpHandlerFactory.Instance, null);
    ...
    public Kernel Build() =>
        new(null, this._aiServices.Build(), this._serviceSelector, this._httpHandlerFactory, this._loggerFactory);
