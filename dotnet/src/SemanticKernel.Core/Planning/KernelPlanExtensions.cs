...
public static class KernelPlanExtensions
{
    ...
    public static IKernelFunction ImportPlan(this Kernel kernel, Plan plan)
    {
    ...
    /// <returns>Function definition for the plan</returns>
    public static IKernelFunction ImportPlanFromJson(this Kernel kernel, string json)
    {
        return kernel.RegisterCustomFunction(Plan.FromJson(json, kernel.Functions));
    }
