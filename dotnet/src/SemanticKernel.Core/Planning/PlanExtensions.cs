...
public static class PlanExtensions
{
    ...
    /// <summary>
    /// Returns decorated instance of <see cref="IKernelFunction"/> with plan enabled instrumentation.
    /// </summary>
    /// <param name="plan">Instance of <see cref="Plan"/> to decorate.</param>
    /// <param name="loggerFactory">The <see cref="ILoggerFactory"/> to use for logging. If null, no logging will be performed.</param>
    public static IKernelFunction WithInstrumentation(this Plan plan, ILoggerFactory? loggerFactory = null)
    {
