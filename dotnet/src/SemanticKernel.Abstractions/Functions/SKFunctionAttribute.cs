...
/// <see cref="CancellationToken"/> are filled in from the corresponding members of the <see cref="KernelContext"/>;
/// <see cref="KernelContext"/> itself may also be a parameter. A given native function may declare at
