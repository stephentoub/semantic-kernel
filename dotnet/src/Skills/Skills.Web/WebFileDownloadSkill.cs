...
public sealed class WebFileDownloadSkill : IDisposable
{
    ...
    public async Task DownloadToFileAsync(
        [SKName("input"), Description("URL of file to download")] string source,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        using HttpResponseMessage response = await this._httpClient.GetAsync(new Uri(source), HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false);
