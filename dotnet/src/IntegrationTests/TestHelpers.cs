...
internal static class TestHelpers
{
    ...
    internal static IDictionary<string, IKernelFunction> ImportSamplePlugins(Kernel kernel, params string[] pluginNames)
    {
        return ImportSampleSemanticFunctions(kernel, "../../../../../../samples/plugins", pluginNames);
    }

    internal static IDictionary<string, IKernelFunction> ImportSampleSemanticFunctions(Kernel kernel, string path, params string[] pluginNames)
    {
