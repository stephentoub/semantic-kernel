...
public record RestApiOperationPayload
{
    ...
    /// </summary>
    public SKParameterTypeJsonSchema? Schema { get; }
    ...
    public RestApiOperationPayload(string mediaType, IList<RestApiOperationPayloadProperty> properties, string? description = null, SKParameterTypeJsonSchema? schema = null)
    {
